...
open class OneLastActivity: NSObject {
	...
	open class func sendLastActivityQueryToJID(_ userName: String, sender: XMPPLastActivity? =
        nil, completionHandler completion:@escaping OneMakeLastCallCompletionHandler) {
